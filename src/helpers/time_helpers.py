...
async def convert_pb_to_time(case:int, time_string:str)-> time:
    ...
    if case == 2:
        hours_string , minutes_string, seconds_and_milliseconds_string = time_string.split(":")
    ...
    if minutes > 59:
        hours = minutes // 60
        minutes = minutes % 60
    return time(hours, minutes, seconds, milliseconds * 1000,  tzinfo=Eastern_Standard_Timezone())