BOARD_PIECE_IMAGES = {
    ...
    5: "src/summerland/images/piece_team5.png",
    6: "src/summerland/images/piece_team6.png",
    7: "src/summerland/images/piece_team7.png",
    8: "src/summerland/images/piece_team8.png",
}
