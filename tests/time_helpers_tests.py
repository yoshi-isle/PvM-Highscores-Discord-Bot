...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("0:07.4", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("0:02.0", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("0:02", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("0:02", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("0:47.4", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("1:00.00", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("3:21.2", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("3:21.0", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("67:34.12", time_helpers.TimeInput.INPUT_AS_MINUTES_ONLY),
        ("1:00:00", time_helpers.TimeInput.INPUT_WITH_HOURS),
        ("1:00:00.0", time_helpers.TimeInput.INPUT_WITH_HOURS),
        ("1:03:23.3", time_helpers.TimeInput.INPUT_WITH_HOURS),
        ("4:33:23", time_helpers.TimeInput.INPUT_WITH_HOURS),
        ("", time_helpers.TimeInput.BAD_INPUT),
        ("abc", time_helpers.TimeInput.BAD_INPUT),
        ("2", time_helpers.TimeInput.BAD_INPUT),
        (":2", time_helpers.TimeInput.BAD_INPUT),
        (".2", time_helpers.TimeInput.BAD_INPUT),
        ("1::00.3", time_helpers.TimeInput.BAD_INPUT),
        ("1:00.3.3", time_helpers.TimeInput.BAD_INPUT),
        ("01:00:00", time_helpers.TimeInput.BAD_INPUT),
        ("1:00:", time_helpers.TimeInput.BAD_INPUT),
        ("1:00:0", time_helpers.TimeInput.BAD_INPUT),
        ("1:0.3", time_helpers.TimeInput.BAD_INPUT),
        ("1.0.3", time_helpers.TimeInput.BAD_INPUT),
        ("1:0:3", time_helpers.TimeInput.BAD_INPUT),
    ],
)
